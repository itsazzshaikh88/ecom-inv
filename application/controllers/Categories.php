...
class Categories extends App_controller
{
    ...
    function add()
    {
        ...
        try {
            ...
            $category = $this->Category_model->get_category_by_name($data['name']);
            if (!empty($category)) {
    ...
    function update($id)
    {
        ...
        try {
            ...
            // Save Data to the product table
            $updatedCategory = $this->Category_model->update_category($id, $data, $isAuthorized['userid']);
    ...
    function delete($id)
    {
        ...
        $category = $this->Category_model->get_category_by_id($id);
        $result = $this->Category_model->delete_category_by_id($id);
        if ($result) {
            $this->output
                ->set_content_type('application/json')
