<form id="form" method="post" enctype="multipart/form-data" onsubmit="submitForm(event)">
    ...
    <div class="row">
        <div class="col-md-12 mt-4">
            <div class="row mb-1">
                <label class="col-sm-4 col-form-label col-form-label-sm" for="name">Category Name <span class="text-danger">*</span> <span class="float-end d-none d-lg-block">:</span> </label>
                <div class="col-sm-8">
