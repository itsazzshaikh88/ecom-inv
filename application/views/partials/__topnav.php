        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="<?= base_url() ?>">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img src="assets/img/logo/logo-task.png" alt="phoenix" width="40" />
                        <h5 class="logo-text ms-2 d-none d-sm-block fw-bolder">
                            <span class="text-info">In</span><span class="text-black">ventory</span>
                        </h5>
                    </div>
                </div>
            </a>
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
                ...
                <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border navbar-dropdown-caret" id="navbarDropdownNotfication" aria-labelledby="navbarDropdownNotfication">
                    <div class="card position-relative border-0">
                        ...
                        <div class="card-footer p-0 border-top border-translucent border-0">
                            <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a class="fw-bolder" href="pages/notifications.html">Show all notifications</a></div>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle " src="assets/img/custom/avatar2.webp" alt="" />
                    </div>
                </a>
                    ...
                    <div class="card position-relative border-0">
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                ...
                                <h6 class="mt-2 text-body-emphasis"><?= $loggedInUser['username'] ?></h6>
                                <p class="mb-0">
                                    <span class="badge bg-secondary"><?= $loggedInUser['usertype'] ?></span>
                                </p>
                            </div>
                        ...
                        <div class="card-footer p-0 border-top border-translucent">
                            ...
                            <hr />
                            <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="javascript:void(0)" onclick="logoutAction()"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
